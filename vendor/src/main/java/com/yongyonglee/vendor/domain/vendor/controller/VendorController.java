...
import static com.yongyonglee.vendor.domain.vendor.message.SuccessMessage.UPDATE_VENDOR_SUCCESS;
...
public class VendorController {
    ...
    // TODO: 사용자 인증 및 인가(MASTER) 추가
    @PutMapping("/{vendorId}")
    public ResponseEntity<? extends CommonResponse> updateVendor(
            @PathVariable UUID vendorId,
            @RequestBody UpdateVendorRequestDto requestDto) {

        return ResponseEntity.status(UPDATE_VENDOR_SUCCESS.getHttpStatus())
                .body(success(UPDATE_VENDOR_SUCCESS.getMessage(), vendorService.updateVendor(vendorId, requestDto)));
    }
